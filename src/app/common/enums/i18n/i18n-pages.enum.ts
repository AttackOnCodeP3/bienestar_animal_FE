...
export enum I18nPagesEnum {
  ...
  CREATE_MUNICIPALITY_PAGE = 'create-municipality-page',
  ...
  NOTIFICATION_RULES_PAGE = 'notification-rules-page',
  ...
  CREATE_MUNICIPALITY_PAGE_TITLE = I18nPagesEnum.CREATE_MUNICIPALITY_PAGE + '.title',
  ...
  NOTIFICATION_RULES_PAGE_TITLE = I18nPagesEnum.NOTIFICATION_RULES_PAGE + '.title',
}
